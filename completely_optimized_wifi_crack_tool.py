    ...
    class Crack:
        ...
        def search_wifi(self):
            ...
            try:
                ...
                # 优化扫描时间，最大不超过3秒
                scan_time = min(self.tool.config_settings_data['scan_time'], 3.0)
